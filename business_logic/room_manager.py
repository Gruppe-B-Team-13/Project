...
class RoomManager:
    ...
    def get_filtered_rooms(self, city: str = None, min_stars: int = None, min_guests: int = None, check_in_date: str = None, check_out_date: str = None) -> list[model.Room]:
        return self.room_dal.get_rooms_filtered(city, min_stars, min_guests, check_in_date, check_out_date)
